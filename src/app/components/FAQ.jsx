  ...
  return (
    <div className="w-[90%] mx-auto mt-12 md:mt-4">
      ...
      <div className="text-center mt-4">
        <button className="bg-blue-800 text-white py-3 px-12 text-[12px] rounded"><button class="transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:duration-300 ...">
  More FAQ
</button> </button>
      </div>
    </div>
